...
public class DbModelSelector {
    ...
    private com.frodo.app.framework.orm.sql.WhereBuilder having;

    private com.frodo.app.framework.orm.sql.Selector selector;

    private DbModelSelector(Class<?> entityType) {
        selector = com.frodo.app.framework.orm.sql.Selector.from(entityType);
    }

    protected DbModelSelector(com.frodo.app.framework.orm.sql.Selector selector, String groupByColumnName) {
        this.selector = selector;
        this.groupByColumnName = groupByColumnName;
    }

    protected DbModelSelector(com.frodo.app.framework.orm.sql.Selector selector, String[] columnExpressions) {
        this.selector = selector;
    ...
    public DbModelSelector where(com.frodo.app.framework.orm.sql.WhereBuilder whereBuilder) {
    ...
    public DbModelSelector and(com.frodo.app.framework.orm.sql.WhereBuilder where) {
        selector.and(where);
        return this;
    }
    ...
    public DbModelSelector or(com.frodo.app.framework.orm.sql.WhereBuilder where) {
        selector.or(where);
        return this;
    }
