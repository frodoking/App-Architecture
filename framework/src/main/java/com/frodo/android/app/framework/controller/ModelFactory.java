...
public final class ModelFactory {
    private ConcurrentMap<String, com.frodo.android.app.framework.controller.IModel> modelCache;

    public ModelFactory() {
        modelCache = new ConcurrentHashMap<>();
    }

    public void registerMode(com.frodo.android.app.framework.controller.IModel model) {
        modelCache.putIfAbsent(model.name(), model);
    }

    public com.frodo.android.app.framework.controller.IModel getModelBy(String modelName) {
