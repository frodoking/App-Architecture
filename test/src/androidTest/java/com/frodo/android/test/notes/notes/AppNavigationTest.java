...
package com.frodo.android.test.notes.notes;
...
import com.frodo.android.test.notes.NotesActivity;
import com.frodo.android.test.notes.custom.action.NavigationViewActions;
...
public class AppNavigationTest {
    ...
    public void clickOnStatisticsNavigationItem_ShowsStatisticsScreen() {
        ...
        onView(withId(R.id.nav_view))
                .perform(NavigationViewActions.navigateTo(R.id.statistics_navigation_menu_item));
