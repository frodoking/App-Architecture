...
package com.frodo.android.app.core.database.realm.example;

import com.frodo.android.app.core.database.realm.example.model.Cat;
import com.frodo.android.app.core.database.realm.example.model.Dog;
import com.frodo.android.app.core.database.realm.example.model.Person;
...
public class Introduce   {
    private static final String TAG = Introduce.class.getCanonicalName();
    private Realm realm;

    public Introduce(Context context){
    ...
    private String complexReadWrite() {
        ...
        // FIXME Realm realm = Realm.getInstance(this);
